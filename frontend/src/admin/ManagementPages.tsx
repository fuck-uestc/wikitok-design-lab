...
interface AdminSettings { mcp: { endpoint: string; writeEnabled: boolean; readEnabled: boolean; legacyPasswordEnabled: boolean; protocols: string[] }; site: SiteConfig; limits: { uploadMb: number; importMb: number; importMaxRecords: number; maxFiles: number } }
